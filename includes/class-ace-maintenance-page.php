...
class Ace_Maintenance_Page {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Ace_Maintenance_Page_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'ACE_MAINTENANCE_PAGE_VERSION' ) ) {
			$this->version = ACE_MAINTENANCE_PAGE_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'ace-maintenance-page';
	 ...
	 *
	 * - Ace_Maintenance_Page_Loader. Orchestrates the hooks of the plugin.
	 * - Ace_Maintenance_Page_i18n. Defines internationalization functionality.
	 * - Ace_Maintenance_Page_Admin. Defines all hooks for the admin area.
	 * - Ace_Maintenance_Page_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-ace-maintenance-page-loader.php';
		...
		$this->loader = new Ace_Maintenance_Page_Loader();
	...
	private function set_locale() {
		...
		$plugin_i18n = new Ace_Maintenance_Page_i18n();
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Ace_Maintenance_Page_Admin( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Ace_Maintenance_Page_Loader    Orchestrates the hooks of the plugin.
	 */
